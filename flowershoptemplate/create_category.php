...
$query = "INSERT INTO Products (prodcat, productname, productdesc, productimage, productlink, quantity, lastprice, ourprice) VALUES ('$newCategory', 'New Product', 'New Product Description', 'images/newproduct.jpg', 'products.php', 0, 0, 0)";
...
if ($result) {
    ...
    echo '<li>';
    echo '<a href="#"><img id="product-image" src="images/newProduct.png" alt="New Product"></a>';
